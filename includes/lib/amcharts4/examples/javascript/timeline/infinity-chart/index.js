...
var altColor = new am4core.InterfaceColorSet().getFor("alternativeBackground");
...
var rocketSeries = chart.series.push(new am4plugins_timeline.CurveLineSeries());
...
var rocketBullet = rocketSeries.bullets.push(new am4charts.CircleBullet())
...
var image = chart.curveContainer.createChild(am4core.Image);
image.href = "moon.png";
...
var titleLabel = chart.curveContainer.createChild(am4core.Label);
...
titleLabel.events.on("validated", function () {
...
var nearestDataItem;
var currentNearestBullet;

slider.events.on("rangechanged", function () {
    var value = dateAxis.min + slider.start * (dateAxis.max - dateAxis.min);    
    var difference = Infinity;

    series.dataItems.each(function (dataItem) {
        var newDiff = Math.abs(dataItem.dateX.getTime() - value);
    ...
    var nearestBullet = nearestDataItem.bullets.getKey(bullet.uid);
    if(nearestBullet){
...
var mapChart = chart.curveContainer.createChild(am4maps.MapChart);
...
try {
    ...
    mapChart.raiseCriticalError(new Error("Map geodata could not be loaded. Please download the latest <a href=\"https://www.amcharts4.com/download/download-v4/\">amcharts4 geodata</a> and extract its contents into the same directory as your amCharts files."));
}
